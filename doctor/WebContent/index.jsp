...
<link rel="stylesheet" type="text/css" href="BJUI/other/code/css/verify.css">
<script type="text/javascript" src="BJUI/other/code/js/verify.js" ></script>
<style type="text/css">
...
$(function() {
	...
	$("#login_form").submit(function(){
		...
		if(!($("#logintypecode").val()=="1")){
			//$("#mpanel1").css('border', '1px #ff0000 solid');
			return false;
		}
...
<!--         </div> -->
        ...
        <div class="login_form">
    		...
    		<form action="${pageContext.request.contextPath }/com/login.action" id="login_form" method="post">
    			...
    			<div class="form-group">
    				<div id="code" style="font-size: 14px;margin-left: 126px">
		        	 <div id="mpanel1" ></div>
		         </div>
		         </div>
    			...
    			<input type="hidden" value="" datatype="*" id="logintypecode" nullmsg="向右拖动验证码"/>
    		</form>
        </div>
	</div>
	<script type="text/javascript">
	...
	<div class="bottom">Copyright &copy; 2019 ${appTitle }</a></div>
</div>
</body>
</html>