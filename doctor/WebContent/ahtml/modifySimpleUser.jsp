...
<div class="bjui-pageContent">
	<form action="${ctx}/sys/update${actionclass1}.action" id="j_custom_form"
		...
		<table class="table table-condensed table-hover" width="100%">
			<tbody>
				<tr>
					<td><label for="j_custom_nameuname" class="control-label x85">登录账号：</label>
						<input type="text" name="user.uname"
						value="${modifybean.user.uname}" id="j_custom_nameuname"
						data-rule="required" size="15"></td>
				</tr>
				<tr>
					<td><label for="j_custom_fnamepassword" class="control-label x85">密码：</label>
						<input type="password" name="user.userPassword"
						value="" id="j_custom_fnamepassword"
						data-rule="" size="15"></td>
				</tr>
				<tr>
					<td><label for="j_custom_fnameuserName" class="control-label x85">姓名：</label>
						<input type="text" name="user.userName"
						value="${modifybean.user.userName}" id="j_custom_fnameuserName"
						data-rule="required" size="15"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><label for="j_custom_fnameuserPhone" class="control-label x85">联系电话：</label>
						<input type="text" name="user.userPhone"
						value="${modifybean.user.userPhone}" id="j_custom_fnameuserPhone"
						data-rule="mobile" size="15"></td>
				</tr>
				<tr>
					<td><label for="j_custom_fnameuserEmail" class="control-label x85">邮箱：</label>
						<input type="text" name="user.userEmail"
						value="${modifybean.user.userEmail}" id="j_custom_fnameuserEmail"
						data-rule="email" size="15"></td>
				</tr>
				<tr>
					<td><label for="j_custom_fnameuserBirth" class="control-label x85">出生日期：</label>
						<input type="text" name="user.userBirth"
						value="${modifybean.user.userBirth}" id="j_custom_fnameuserBirth"
						readonly="readonly" data-toggle="datepicker" data-rule="date"
						size="15"></td>
				</tr>
				<tr>
					<td><label for="j_custom_fnameuserAddress" class="control-label x85">联系地址：</label>
						<input type="text" name="user.userAddress"
						value="${modifybean.user.userAddress}" id="j_custom_fnameuserAddress" data-rule=""
						size="15"></td>
				</tr>
