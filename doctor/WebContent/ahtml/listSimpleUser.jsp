...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}.action" method="post">
        ...
        <div class="bjui-searchBar">
            <label>账号：</label><input type="text" value="" id="${actionclass1}_useruname" name="s_user.uname" class="form-control" size="10">&nbsp;
            <label>姓名：</label><input type="text" value="" id="${actionclass1}_useruserName" name="s_user.userName" class="form-control" size="8">&nbsp;
<!--             <label>:</label> -->
