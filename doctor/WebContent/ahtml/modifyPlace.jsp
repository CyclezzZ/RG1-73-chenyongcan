	...
	<form action="${ctx}/sys/update${actionclass1}.action" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
		...
		<table class="table table-condensed table-hover" width="100%">
			<tbody>
				<tr>
					<td>
						<label for="Place_sid" class="control-label x100">车位编号：</label>
						<input type="text" name="sid" value="${modifybean.sid}" id="Place_sid" data-rule="required" size="50">
					</td>
				</tr>
				<tr>
					<td>
						<label for="Place_name" class="control-label x100">车位名称：</label>
						<input type="text" name="name" value="${modifybean.name}" id="Place_name" data-rule="required" size="50">
					</td>
				</tr>
			</tbody>
		</table>
