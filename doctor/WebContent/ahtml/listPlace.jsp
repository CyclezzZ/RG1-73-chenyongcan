...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${ctx}/sys/query${actionclass1}.action" method="post">
        ...
        <div class="bjui-searchBar">
            <label>车位编号：</label><input type="text" value="" id="${actionclass1}_sid" name="s_sid" class="form-control" size="10">&nbsp;
            <label>车位名称：</label><input type="text" value="" id="${actionclass1}_name" name="s_name" class="form-control" size="10">&nbsp;
<!--             <label>:</label> -->
